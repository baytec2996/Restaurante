...
<div class="row page-titles">
    <div class="col-md-5 col-8 align-self-center">
        <h4 class="m-b-0 m-t-0">Pagos</h4>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?php echo URL; ?> pago " class="link">Inicio</a></li>
    ...
    <div class="col-md-9">
        <div class="card">
            ...
            <ul class="nav nav-tabs customtab" role="tablist">
                <li class="nav-item"> <a class="nav-link list-personas active" data-toggle="tab" href="#contenido" role="tab"><span class="hidden-sm-up">Cancelados</span> <span class="hidden-xs-down">Cancelados</span></a> </li>
                <li class="nav-item"> <a class="nav-link list-empresas" data-toggle="tab" href="#contenido" role="tab"><span class="hidden-sm-up">Pendientes</span> <span class="hidden-xs-down">Pendientes</span></a> </li>
            </ul>
            <!-- Tab panes -->
                        ...
                        <div class="table-responsive m-b-10">
                            <table id="table" class="table table-condensed table-hover stylish-table" cellspacing="0" width="100%">
                                <thead class="table-head">
                                    ...
                                    <th style="width: 20%; text-align: center;">Ver Boleta</th>
