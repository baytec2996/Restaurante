...
define('EURO',chr(128));
$pdf = new FPDF_CellFiti('P','mm',array(80,250));
$pdf->AddPage();
...
//	$pdf->Image($url_logo,15,0,L_DIMENSION,0,L_FORMATO);
//	$pdf->Cell(0,30,'',0,1,'C');
//}
...
$pdf->Cell(0,4,'TELF: '.utf8_decode($this->empresa['celular']),0,1,'C');
 
// DATOS FACTURA
$elec = (($this->dato->id_tdoc == 1 || $this->dato->id_tdoc == 2) && Session::get('sunat') == 1) ? 'ELECTRONICA' : '';     
$pdf->Ln(3);
$pdf->SetFont('Helvetica', 'B', 10);
$pdf->Cell(0,4,utf8_decode($this->dato->desc_td).' '.$elec,0,1,'C');
$pdf->Cell(0,4,utf8_decode($this->dato->ser_doc).'-'.utf8_decode($this->dato->nro_doc),0,1,'C');
$pdf->Ln(2);
$pdf->SetFont('Helvetica', '', 9);
...
//else  // para lugares ===> sin IGV usar esta linea para otros linea de arriba
...
$pdf->MultiCell(47,4,utf8_decode('Representacion impresa de la '.$this->dato->desc_td).' '.$elec.' consulte en',0,'C');
$pdf->MultiCell(60,4,'sunat.gob.pe',0,'R');
