...
<head>
    ...
    <meta name="theme-color" content="#2f548f">
    <meta name="msapplication-navbutton-color" content="#2f548f">
    ...
    <meta name="msapplication-TileImage" content="<?php echo URL; ?>public/images/favicons/">
    <meta name="theme-color" content="#ffffff">
    <?php
        if (isset($this->title_page))
        {
            echo '<title>SISTEMA | '.$this->title_page.'</title>';
        }
        else{
            echo '<title>SISTEMA </title>';
        }
    ?>
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    ...
                    <?php } ?>
                        <!-- Logo icon -->
                        <b>
                            <img src="<?php echo URL; ?>public/images/icon-insaga-rest.png" width="50px"/>
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span>
                       
                            <span class="font-16 font-medium text-white">Sistema</span><span class="font-16 font-medium text-white">Restaurant</span> 
                        </span> 
                    </a>
                </div>
                <!-- ============================================================== -->
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    <?php endif; ?>
                         <li id="pago"><a class="waves-effect waves-dark" href="<?php echo URL; ?> pago " aria-expanded="false"><svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><path fill="#444444" d="M8.2 6.8c-0.1 0-0.1-0.1-0.2-0.1v-3.1c1.2 0.1 2.2 0.6 2.2 0.6l0.9-1.8c-0.1 0-1.5-0.8-3.1-0.8v-1.6h-1v1.6c-0.8 0.2-1.4 0.5-2 0.9-0.6 0.6-1 1.4-1 2.3 0 0.7 0.2 2.3 3 3.6v3.9c-0.9-0.2-2-0.7-2.4-0.9l-1 1.7c0.2 0.1 1.8 1 3.4 1.2v1.7h1v-1.7c0 0 0 0 0 0 2.3-0.3 3.6-2.1 3.6-3.8 0-1.5-1-2.7-3.4-3.7zM7 6.2c-0.8-0.5-1-1-1-1.3 0-0.4 0.1-0.7 0.4-0.9 0.2-0.1 0.4-0.2 0.6-0.3v2.5zM8 12.3v-3.4c1.1 0.5 1.6 1.1 1.6 1.6 0 0.6-0.3 1.6-1.6 1.8z"></path></svg><span class="hide-menu"> Pagos</span></a>
                        </li>
                    </ul>
                </nav>
